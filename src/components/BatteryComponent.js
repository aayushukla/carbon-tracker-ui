...
function BatteryComponent(props) {
    ...
    const [batteryLength, setLength] = useState([]);
    ...
    return (
        <>
            ...
            <div className="co2container">
                ...
                <main style={{ margin: '2%' }}>
                    <h4 style={{ margin: '2%', fontWeight: 'bold', fontSize: '150%', marginBottom: '50px', textAlign:'center' }}>
                        Battery Supplier</h4>
          ...
          <Card  style = {{marginTop:'15px',alignItems:'center', display:'flex', justifyItems:'center'}} className='text-center'>
           <Card.Img style = {{width:'50%'}} src="https://www.totalbattery.com/wp-content/uploads/2019/03/solar-group-768x459.jpg">
              ...
              <Card.Text style = {{marginTop:'1px'}}>
                Find more about Battery Suppliers!
              </Card.Text>
          </Card>
