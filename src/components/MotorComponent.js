          ...
          <Row xs={1} md={2} className="g-4">
            ...
            <Col>
              ...
              <Card style={{ marginTop: '15px' }} className='text-center'>
                <Card.Body >
                  Are you looking for Historical Data of Motor?
                  <br></br>
            ...
            <Col>
              ...
              <Card style={{ marginTop: '15px', alignItems: 'center', display: 'flex', justifyItems: 'center' }} className='text-center'>
                <Card.Img style={{ width: '50%', height: '10%' }} src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS9iicPwQGnG0ggTDyPk_CS48tl3xgkcfOYiQ&usqp=CAU">

                </Card.Img>
                <Card.Text style={{ marginTop: '1px', marginBottom: '2%' }}>
                  <a href="">Find more about Motor Supplier!</a>
                </Card.Text>
              </Card>
